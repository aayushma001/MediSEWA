...
export const Specialities: React.FC = () => {
    ...
    const [specialities, setSpecialities] = useState<Speciality[]>([
        { id: '1', name: 'Cardiology', description: 'Heart and cardiovascular system care', color: 'bg-red-50 text-red-600' },
        { id: '2', name: 'Neurology', description: 'Disorders of the nervous system', color: 'bg-indigo-50 text-indigo-600' },
        { id: '3', name: 'Pediatrics', description: 'Medical care of infants, children, and adolescents', color: 'bg-green-50 text-green-600' },
    ]);
    ...
    const handleAddSpeciality = (e: React.FormEvent) => {
        ...
        const speciality: Speciality = {
            ...
            color: 'bg-blue-50 text-blue-600' // Default color
        };
