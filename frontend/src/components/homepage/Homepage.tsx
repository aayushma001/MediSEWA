...
export const Homepage: React.FC<HomepageProps> = ({ onOpenAuthModal }) => {
  ...
  return (
    <div className="homepage-root relative min-h-screen font-sans overflow-hidden">
      ...
      <div className="py-20 bg-gray-50/50 backdrop-blur-sm relative z-10 overflow-hidden pt-[30px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center mb-12">
            <span className="inline-block text-lg font-bold text-blue-600 bg-white px-8 py-3 rounded-full mb-5 shadow-md uppercase tracking-wide transform hover:scale-105 transition-transform">
              Top Specialties
            </span>
